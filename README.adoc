= Samples Spring Boot 3 Authorization Server 2025
The origins of samples are located https://github.com/spring-projects/spring-authorization-server/tree/main/samples[here]
...
* Embedded database is located `jdbc:h2:tcp://localhost:9092/mem:testdb` or `http://localhost:9000/h2-console/`
** Login with credentials -> sa \
